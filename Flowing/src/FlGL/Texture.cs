...
namespace Flowing.FlGL
{
    ...
    public class Texture
    {
        ...
        private OpenTK.Graphics.OpenGL.TextureMinFilter min;
        private OpenTK.Graphics.OpenGL.TextureMagFilter mag;
        ...
        public Texture(Bitmap textureBitmap, OpenTK.Graphics.OpenGL.TextureMinFilter min, OpenTK.Graphics.OpenGL.TextureMagFilter mag)
        {

            Handle = GL.GenTexture();
            Use();
            using (var image = new Bitmap(textureBitmap))
            {
                var data = image.LockBits(
                    new Rectangle(0, 0, image.Width, image.Height),
                    ImageLockMode.ReadOnly,
